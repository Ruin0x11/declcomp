...
function _M.tostring(t,idn,indent, attr_indent, xml, xml_escape)
    local buf = {};
    if xml then
    ...
    _dostring(t, buf, _dostring, xml_escape or _M.xml_escape, nil,idn,indent, attr_indent);
    return t_concat(buf);
end
